...
#          - compiler    : Clang / Clang++ version 18
...
set( CMAKE_LINKER "ld.lld-18" CACHE FILEPATH "Default linker" )
set( CMAKE_EXE_LINKER_FLAGS_INIT "-fuse-ld=lld-18" )
set( CMAKE_MODULE_LINKER_FLAGS_INIT "-fuse-ld=lld-18" )
set( CMAKE_SHARED_LINKER_FLAGS_INIT "-fuse-ld=lld-18" )
